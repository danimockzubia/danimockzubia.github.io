...
$recepient = "mockzubia@gmail.com";
$subject = "Let's chat";
$is_sender_required = false;     //if this is set to "true" email will be not sent if senders email is empty, set it to "false" if you want to send email anyway
